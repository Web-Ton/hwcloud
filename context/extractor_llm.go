...
func NewLLMExtractor(modelFn func() hwcloud.Model, p MemoryProvider) *LLMExtractor {
...
func (e *LLMExtractor) SetModel(m hwcloud.Model) {
	e.mu.Lock()
	defer e.mu.Unlock()
	e.modelFn = func() hwcloud.Model { return m }
}
...
func (e *LLMExtractor) SetModelFn(fn func() hwcloud.Model) {
	e.mu.Lock()
	defer e.mu.Unlock()
	e.modelFn = fn
}
